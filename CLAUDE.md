...
- 검증: `node --check`(app·core·API) + 회귀 **51/51·18/18**(일간뷰 3열·기수 태그·컵색≠빨강·범례 컵참관단 제거+1/2기·식사 7일×3끼·대원 기본토글) + 헤드리스(8/7 3열 스샷·1기 블루블록·구스킴 자동정리·식사 저장·**콘솔 에러 0**). ⏳ 미완: 자료실 카테고리 자유추가.
