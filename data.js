...
// Schema:
//   { id (auto), name, type("Community unit"|"School unit"),
//     country(EN, WOSM official), country_ko, nso, region, lang,
//     lat, lng, sections[]("Beaver"|"Cub"|"Scout"|"Venture"|"Rover"),
//     homepage(URL — homepage/Instagram), note }
//
//   Pin color = WOSM Region (SCOUT_REGION_COLORS).
//   Coordinates are set in the admin by searching the map to an address
//   and clicking/dragging the marker (no stored street address).
// -----------------------------------------------------------------------------
...
// WOSM official country/NSO list (country select source). country EN = WOSM official name.
...
// WOSM region colors — pins/legend.
