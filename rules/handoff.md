...
- 📅 **예약된 작업 — 2026년 말 KV 일괄 삭제**(사용자 확정 2026-08-14). 백업은 **이미 끝났다**(`~/Desktop/Legacy/`, 키 66/66 · 사진 29/29 · 개인정보 CSV 2종). 실행은 `node scripts/purge-retired-kv.js --confirm` — 기본은 미리보기다.
