...
1. **회귀 전체 스위트를 2회 연속 통과**한다(2026-07-28 사용자 확정: 3회→2회). 관련 없어 보여도 매번 전부 돌린다.
   - `planning 147 · nav 19 · server 16 · motion 25 · press 31 · news 111 · jebo 29 · fnc(플립북) 92 · fnc보드 77 · 랜딩 38 · a11y스윕 36 · admin 42 · tour-csv 25 · fnc안정성 30` = 618건 + 감사 3종 (한 바퀴 약 20분)
...
- 검증: fnc-stability **30 → 59/59** · planning-server **16 → 34/34**(둘 다 배포 모듈 그 자체를 가짜 KV 로). 전체 스위트 결과는 아래 '완료 정의' 기준으로 기록.
