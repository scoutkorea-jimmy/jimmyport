...
1. **회귀 전체 스위트를 2회 연속 통과**한다(2026-07-28 사용자 확정: 3회→2회). 관련 없어 보여도 매번 전부 돌린다.
   - `planning 225 · nav 19 · server 85 · motion 33 · press 31 · news 112 · jebo 32 · fnc(플립북) 92 · fnc보드 84 · 랜딩 38 · a11y스윕 36 · admin 42 · tour-csv 25 · fnc안정성 59 · audit-mobile 1` = **914건** + 감사 2종(`audit-krjam-planning`·`audit-krjam-fnc`) (한 바퀴 약 6분)
...
- 회귀: server **85→104** · planning **225→234** · 랜딩 **38→45** · 제보 **32→40** · fnc보드 **84→86**.
